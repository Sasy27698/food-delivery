...
int main(int argc,char **argv)
{
    ...
    servadd.sin_port=htons(1025); //1025 porta per il ristorante-rider
    ...
    FullWrite(sockfd,&IDRistorante,sizeof(rist)); //Invio 0 per sincronizzarmi con il server e invio i dati appena creati
    puts("\nSto inviando....\n");
    int servfd;
