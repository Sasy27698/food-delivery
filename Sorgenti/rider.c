...
int main(int argc, char ** argv) 
{
    ...
    //scanf("%d",&porta);
    servadd.sin_port = htons(1025); //Porta 1025 per comunicare con il ristorante
    ...
    while(1){
      ...
      sync=7;           
      FullWrite(sockfd,&sync,sizeof(int));      //Mandando 7 mi sincronizzo con il ristorante, e controllo se ce un ordine disponibile
